---
title: 'Emotional leadership and the iceberg model: what below the surface drives business risk'
slug: emotional-leadership-smb-iceberg-model-risk
date: '2026-04-17'
category: SME
author: till-blania
excerpt: '* The iceberg model in this episode does not mean "bad entrepreneurs", but:
  visible work often focuses on the small upper part – knowledge, figures, processes
  – whilst emotional and systemic elements lie below the waterline and still shape
  steering, pace and trust.'
hero_image: img/blog/emotionale-fuehrung-kmu-eisbergmodell-risiko-hero.png
hero_alt: Emotional leadership and the organisational iceberg
draft: false
related_slugs: []
faq:
- question: Does the episode claim German entrepreneurs are "bad"?
  answer: No. The point is that alongside proven performance style, additional levers
    in emotional and systemic maturity may lie unused – not a blanket judgement.
- question: Are hard facts unimportant?
  answer: No. Processes, IT, finance and operational steering remain central; the
    podcast argues for combining them with interpersonal clarity, not for deprioritising
    them.
- question: What should I understand by the iceberg model in a business context?
  answer: Figures, rules and role descriptions are often visible; less visible are
    emotional patterns, mistrust, unclear handovers of responsibility and cultural
    habits – they still affect quality and pace.
- question: Is this the same as "esoteric" leadership?
  answer: 'The conversation deliberately differentiates: it is about comprehensible
    perception and systems thinking, not a substitute for rational decisions or unproven
    single doctrines.'
- question: How does this connect to AI?
  answer: 'The thesis is: simple cognitive routine work will become more automatable;
    human strengths such as empathy, judgement and creative linking gain relative
    weight.'
- question: What can I do first, concretely?
  answer: 'Plan short conscious pauses, walk through one concrete interface in the team
    (not only formally, but: who really carries what emotionally?) and follow your
    own stress reactions once to the next cause instead of escalating immediately.'
- question: What about people who do not want to develop their role further?
  answer: 'The episode stresses: satisfaction in fitting, modest roles is legitimate;
    it is not about forced self-optimisation, but genuine fit and appreciation.'
---

* The iceberg model in this episode does not mean "bad entrepreneurs", but: visible work often focuses on the small upper part – knowledge, figures, processes – whilst emotional and systemic elements lie below the waterline and still shape steering, pace and trust.

  * Classic performance and hard work explain much in the German Mittelstand; guest Andreas argues additionally that with AI much "performance" becomes automatable and the interpersonal, emotional lever moves more centre stage.

  * Hard facts (processes, IT, investment) remain indispensable; in the podcast it is about integration: interfaces between roles must be not only formally clear, but emotionally viable – otherwise things jam despite the handbook.

  * Emotional leadership here means above all: perceiving your own responses instead of immediately translating them into control or short-term action – with an everyday image: child cries, is held, emotion runs through, then it continues.

  * The skills shortage is partly discussed as the wrong question: less "more heads for the line", more spaces where people can contribute with their strengths – without forcing everyone into self-optimisation.

  * Companies that permanently sleep through change risk market share, attractiveness and ultimately survival; personal development is described as an accelerator alongside technology.
...
[Watch the podcast episode](https://youtu.be/VKH-2GhAWxU)
