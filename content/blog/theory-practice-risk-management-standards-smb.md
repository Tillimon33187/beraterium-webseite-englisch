---
title: 'Theory and practice in risk management: when standards stay on paper'
slug: theory-practice-risk-management-standards-smb
date: '2026-06-18'
category: Risk management
author: till-blania
excerpt: 'Standards, certificates and contracts often describe a perfect world — in operations, people interpret, adapt or bypass them. Episode 18 maps the gap.'
...
related_slugs:
  ...
  - employee-awareness-risk-conscious-culture
  - what-is-risk-management
faq:
  - question: Does episode 18 claim ISO certificates are worthless?
    answer: No. Standards provide orientation and can be useful — the problem arises when the certificate is confused with lived practice or implementation is pushed top-down only.
  - question: Does CE marking guarantee safety?
    answer: No. CE signals basic product requirements but neither replaces spot checks on every unit nor your own duty of care in purchasing, storage and maintenance.
  - question: What does "being in the right is not the same as getting your rights" mean?
    answer: A formally correct contract, promise or standard does not automatically mean enforceable protection — interpretation, a partner's insolvency or practical enforcement can undermine it.
  - question: Do SMEs need the same rule density as large corporations?
    answer: Rules can make sense, but not every requirement fits every company size. What matters is which risks you actually carry and what you can bear in euros and in daily operations.
  - question: How does risk assessment in euros help with interpretation disputes?
    answer: Instead of debating "high" or "medium", quantifying in euros under clear assumptions creates a shared language — those involved later understand what was discussed.
  - question: Does this article replace legal or insurance advice?
    answer: No. Contracts, liability and policy terms need qualified professional review in doubt — this piece frames risks but does not replace case-by-case advice.
---

* Standards, certificates and contracts often describe a perfect world — in operations, people interpret, adapt or bypass them. Episode 18 maps the gap.

* Episode 18 of Risiko Radar compares standard assumptions with operational reality — from ISO certificates and CE marking to guarantees, contracts and safety rules.

  * A certificate on the wall is not the same as lived risk management: Peter warns against confusing documentation with reality; Till adds that top-down rules without a shared "why" often trigger employee resistance.

  * Standards such as ISO or CE can protect — but not blindly: fake markings, spot checks instead of full inspection and worn equipment in daily use show where theory stops.

  * Guarantees, delivery or price promises and insurance terms often hide exceptions in the fine print — if the partner goes insolvent, little remains of the promise.

  * Contracts and specifications are only as strong as their enforceability: a public prosecutor put it sharply — everything disputable or open to interpretation in court is problematic.

  * Safety and IT rules help only when implementation and regular checks are lived — not when the rulebook alone exists.

  * Till closes with an operational question: not being able to insure everything is normal — what matters is what failure costs and whether you can absorb the damage.

  * Peter's pattern: rules describe a perfect, unambiguous world on paper — reality interprets, adapts and acts anyway. Not every rule is wrong, but not every rule improves practice.
...
To [build employee awareness of risk](/blog/employee-awareness-risk-conscious-culture/), you need more than a handbook — clarity about what counts when it matters.
...
For [business security and risk management](/blog/business-security-risk-management-smb/), the point is not maximum regulation by default — but depth matched to your damage potential.
...
In risk terms: promise and reality sit on different sides. Weigh whether you trust the counterparty, whether the promise holds on impossibility or insolvency — and whether you carry the rest as a conscious risk or insure it. Not blind trust — but thinking in euros and scenarios, as the [Beraterium method](/method/) proposes.
...
According to the Allianz Risk Barometer, 52% of companies in Germany name cyber risk as the top threat in 2026 — paper compliance without ongoing checks does not close that gap. To [understand why employees make risky decisions](/blog/why-employees-make-risky-decisions/), the answer is often the same: rules without understood meaning in daily work.
...
[Watch episode](https://youtu.be/HGqm1s1wOXs)
