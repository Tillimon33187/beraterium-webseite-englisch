---
title: 'Security in business: when people become the biggest risk'
slug: business-security-risk-management-smb
date: '2026-01-31'
category: KMU
author: till-blania
excerpt: '* Prioritise by criticality, not value: the 120-tonne stainless steel stock can sit in the open – but the €5,000 specialist tools with a three-week lead time need high security'
...
* Prioritise by criticality, not value: the 120-tonne stainless steel stock can sit in the open – but the €5,000 specialist tools with a three-week lead time need high security
  * The 3-2-1 backup rule as a lifeline: 3 copies, 2 media, 1 offline. 82% of all ransomware attacks hit small businesses
  * AI in 2026 is both curse and blessing: 34% of SMEs use AI for 30–40% efficiency gains, yet 32% see AI as the second-biggest risk. The EU AI Act brings fines of up to €35 million from August 2026
  * Raise employee awareness instead of controlling: 40–50% of all cyber attacks stem from human error – explaining creates acceptance instead of resistance
  * Iterative risk management: risk never reaches zero – the goal is to make it continuously smaller and smoother
  * Take new threats seriously: QR code phishing (quishing) bypasses conventional security filters – one scanned invoice can bring down your entire company network
...
[Watch the podcast episode](https://youtu.be/EBHM5Npnipk)
