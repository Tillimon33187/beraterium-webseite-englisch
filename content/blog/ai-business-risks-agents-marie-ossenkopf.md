---
title: 'AI in Business: Agents, Opportunity and the Risk of Diffused Accountability'
seo_title: 'AI in Business: Risks & Agents'

primary_keyword: ai business risk
secondary_keywords:
  - ai agents risk
  - prompt injection business
slug: ai-business-risks-agents-marie-ossenkopf
date: '2026-08-03'
category: Risk management
author: till-blania
excerpt: 'AI agents promise speed — without process and accountability they become risk. How founders and SMEs capture upside without losing the human in the loop.'
...
faq:
  - question: Is AI for business more opportunity or threat?
    answer: Both. Rollback is unrealistic — what matters is whether you run AI as a tool with clear accountability or delegate responsibility to systems that neither judge nor bear consequences.
  - question: What is the biggest mistake when deploying AI agents?
    answer: Automating processes you do not understand — and accepting outputs nobody owns. Text gets faster; decisions get slower.
  - question: What is prompt injection in plain terms?
    answer: Hidden instructions in emails, PDFs or images can trigger unwanted agent actions — from data leaks to stolen API keys. An operational risk, not a pure IT topic.
  - question: Should I use AI agents for HR or email?
    answer: Only with explicit human final decisions, access limits and review points. Screening without judgment admits the wrong profiles and filters out the right people — often invisibly.
  - question: Can I ignore AI as a founder?
    answer: Ignoring it is still a strategic choice. You may fall behind on innovation speed — reckless use creates privacy, reputation and costly decision failures.
  - question: How do useful and risky AI use differ?
    answer: Useful where AI sorts information and prepares decisions — risky where final calls, customer contact or data access go to agents without management.
  - question: What does practice recommend for getting started?
    answer: Understand the process, involve stakeholders, avoid FOMO, and manage AI like motivated interns — prep work yes, accountability human.
---

* AI agents promise speed — without process and accountability they become risk. How founders and SMEs capture upside without losing the human in the loop.

  * Artificial intelligence is no longer an optional IT project — it is a field for probability, damage and governance, comparable to cyber risk but spreading faster with weaker traceability.

  * Agents reproduce average human behaviour without evolutionary judgment or consequences — which makes email automation, HR screening and customer chat the riskiest deployments today.

  * Prompt injection, privacy violations and missing agent identity turn the market into an operational Wild West — not because regulation is absent, but because actors and origin often stay invisible.

  * AI does not automatically speed teams up — when accountability diffuses (“the AI wrote it”), decisions slow down; bad processes become digital, not better.

  * The upside is real — overnight prototypes, large-scale text sorting, organisational prep work — as long as humans keep judgment, liability and stakeholder perspective.

  * The intern framework captures the learnings — AI delivers drafts and sorting, not final decisions without review, ownership and consequence.
...
Dr Marie Ossenkopf — PhD in cooperative AI agents and reinforcement learning, startup coach at [Problem-Raum](https://problem-raum.de/) and co-founder of nonprofit [ConKind](https://conkind.org) for safer agents — frames the opportunity: agents can populate digital space while humans live physical life consciously. That is a design question: **What do we refuse to give up?**
...
The pattern repeats: **What does the error cost — and who carries it?** If the answer is unclear, it is not an efficiency project but a [risk management](/blog/what-is-risk-management/) gap.
...
The upside remains: faster prep, better sorting, shorter innovation cycles — if humans keep judgment, liability and stakeholders at the centre. That is [risk management](/blog/what-is-risk-management/) Beraterium-style: name, assess, act — not collect tools.

**Next step:** Pick one process you know. Define ownership, data scope and worst case. Then agent — not the other way around.

Further reading: [AI and risk management — people first](/blog/ai-and-risk-management-people-first/) and [Avoiding startup mistakes](/blog/startup-mistakes-avoid-risk-management/).
...
- **“Impact Gründen” podcast:** [Spotify](https://open.spotify.com/show/2z7lUXPhNmhtGVeKWcuWfg) · [Apple Podcasts](https://podcasts.apple.com/us/podcast/impact-gr%C3%BCnden-der-startup-coaching-podcast/id1833265088)
- **AGI consciousness blog:** [marieossenkopf.webnode.page/thinking-about-agi](https://marieossenkopf.webnode.page/thinking-about-agi/)
- **ConKind:** [conkind.org](https://conkind.org)

### 🎧 Full podcast episode:

[Watch Risk Radar episode 19 on YouTube](https://youtu.be/UlmnxycxiYg)
