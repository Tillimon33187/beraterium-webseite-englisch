---
title: 'Health as business risk: body, team and the small levers'
slug: founder-health-risk-management-nutrition
date: '2026-04-06'
category: Startup
author: till-blania
excerpt: '* Whoever only looks at processes and technology often overlooks the biggest
  operational risk: people who are absent or exhausted.'
hero_image: img/blog/gesundheit-gruender-risikomanagement-ernaehrung-hero.png
hero_alt: 'Health as business risk: body, team and the small levers'
draft: false
related_slugs: []
faq:
- question: Is health really a business risk?
  answer: Yes. Absence or chronic exhaustion of key people affects deadlines, quality,
    costs and trust – analogous to other operational risks.
- question: Why is a fruit basket in the office not enough?
  answer: Because single measures without behaviour and leadership culture often work
    only symbolically when the rest of everyday life continues as before.
- question: What is meant by "eating on the side"?
  answer: Eating during meetings or at the screen splits attention; conscious breaks
    can support digestion and recovery – regardless of exact nutrients.
- question: Do I have to follow a special diet?
  answer: Not necessarily. In the podcast it is about suitable, sustainable nutrition
    in everyday life and individuality; medical assessment belongs with health questions.
- question: Why are small teams especially affected?
  answer: 'Because there is less redundancy: if a central person is absent, capacity
    and know-how are often missed immediately.'
- question: What role does leadership play?
  answer: Without credible appreciation and team co-shaping, programmes fizzle out;
    with the wrong basic stance ("replaceable") acceptance falls.
- question: What are the quickest levers from the episode?
  answer: Real food instead of constant snacks, protect sleep, short conscious meal
    breaks, social depth instead of only small talk, time outdoors.
---
...
* Whoever only looks at processes and technology often overlooks the biggest operational risk: people who are absent or exhausted.
  * Performance and decision quality can creep down over months – long before burnout becomes visible.
  * In conversation with Alexander Schmidt, nutrition is stressed as a small but central lever – often more effective than more "biohacking" on an empty tank.
  * Eating on the side (meeting, screen) denies the body the calm for proper processing – a hidden factor in founders' everyday life.
  * Small teams of five to fifteen people are hit especially hard when a key person is absent: delays, costs, trust with investors.
  * Measures such as a fruit basket or water only help when behaviour and leadership culture come along – otherwise it stays symbolic politics.
...
[Watch the podcast episode](https://youtu.be/7rYlOSx3T50)
