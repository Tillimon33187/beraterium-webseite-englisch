---
title: 'AI and risk management: why people remain the decisive factor'
slug: ai-and-risk-management-people-first
date: '2026-02-15'
category: HR & culture
author: till-blania
excerpt: AI is a powerful tool – but risks arise where humans and AI are not thought
...
* **AI is a powerful tool – but risks arise where humans and AI are not thought through together.** Whoever only bets on new technology and ignores the human factor misses the essentials.
  * **The biggest risk factor with AI is often the user.** Uncritical use, missing training and feeding sensitive data into AI systems lead to misinformation, GDPR breaches and dangers for intellectual property.
  * **Check processes first, then digitise.** A digitised bad process remains a bad process – expensively implemented with AI, without real added value. Before you deploy AI: does my business need this process at all, and in this form?
  * **AI is one topic among many.** Supply chains, people leadership, utility networks, IT outage – all remain relevant. Risk analysis should stay holistic and not focus only on AI.
  * **People shape change.** AI changes work; but whoever defines the steps, assesses processes and takes responsibility is and remains human. Thinking teams are the difference between blind tech use and real benefit.
...
[Watch the podcast episode](https://youtu.be/nst3kzKpPHU)
