---
title: 'EU AI Act in Germany: What Changed for Companies on 2 August 2026'
seo_title: 'EU AI Act Germany: Rules Since 2026'
primary_keyword: eu ai act germany
secondary_keywords:
  - ai act germany companies
  - bundesnetzagentur ai
slug: eu-ai-act-germany-companies
date: '2026-08-04'
category: Risk management
author: till-blania
excerpt: 'The EU AI Act became generally applicable in Germany on 2 August 2026 — transparency duties, fines up to €35m and a new national AI authority.'
...
draft: false
related_slugs:
  - ai-business-risks-agents-marie-ossenkopf
  - ai-and-risk-management-people-first
  - cyber-attack-what-to-do-smb
  - what-is-risk-management
faq:
  - question: 'Does the EU AI Act still apply from 2 August 2026 despite the deadline extension?'
    answer: 'Yes. Only the obligations for high-risk AI systems were postponed. The Act itself, the transparency duties under Art. 50 and the sanctions regime have applied unchanged since 2 August 2026.'
  - question: 'Does the AI Act affect small companies that only use ChatGPT?'
    answer: 'Usually yes. Any company using AI tools in daily work counts as a deployer under the Act — which already triggers the AI literacy duty under Art. 4, in force since February 2025.'
  - question: 'What fines can companies face under the AI Act?'
    answer: 'Up to €35m or 7% of global annual turnover for prohibited practices, and up to €15m or 3% for other violations. SMEs and start-ups benefit from the lower of the two values.'
  - question: 'Which authority enforces the AI Act in Germany?'
    answer: 'Since the KI-MIG entered into force on 29 July 2026, the Bundesnetzagentur (Federal Network Agency) is the central market surveillance authority, single point of contact and complaints office. Sector regulators such as BaFin retain jurisdiction in regulated fields.'
  - question: 'Does our website chatbot now need an AI disclosure?'
    answer: 'An AI system designed to interact directly with people must make clear that users are interacting with AI, unless this is obvious from the context. Check this with your chatbot provider.'
  - question: 'What exactly was postponed, and until when?'
    answer: 'High-risk obligations for standalone systems (Annex III, e.g. candidate screening) now apply from 2 December 2027; for AI embedded in products (Annex I) from 2 August 2028.'
  - question: 'Does this article replace a legal assessment of our AI use?'
    answer: 'No. Whether a specific system qualifies as high-risk AI depends on the individual case. This article summarises the public legal status — for your specific situation we recommend a qualified lawyer.'
---
...
* The EU AI Act became generally applicable in Germany on 2 August 2026 — transparency duties, fines up to €35m and a new national AI authority.
  ...
  * Only part of it was postponed: high-risk AI obligations now apply from December 2027 — the general date of application itself remains 2 August 2026.

  * Any company running a chatbot, publishing AI-generated content, or using tools like ChatGPT in daily work already falls under the Act — regardless of company size.

  * Germany's implementation law (KI-MIG, in force since 29 July 2026) designates the Bundesnetzagentur as the central market surveillance, contact and complaints authority — with its own AI service desk.

  * The sanctions regime is now enforceable: up to €35m or 7% of global turnover for prohibited practices, up to €15m or 3% for other violations.

  * An easily missed deadline falls on 2 December 2026: machine-readable labelling for AI systems that already generated synthetic content before August 2026.

  * The extended high-risk deadlines are preparation time, not a reprieve — companies that sort inventory, roles and labelling now save themselves time pressure in 2027.
...
Both instruments require similar building blocks — governance structures, documented risk assessment, and demonstrable compliance towards regulators and customers — but address different areas: [NIS2](/blog/cyber-attack-what-to-do-smb/) targets the organisation's cybersecurity, the AI Act targets the actual use of AI systems — see also [AI and Risk Management: People First](/blog/ai-and-risk-management-people-first/). Companies affected by both should think of their register, training records and reporting channels together rather than building two separate compliance silos. This links back to the question raised in our article on [AI agents in business](/blog/ai-business-risks-agents-marie-ossenkopf/): who is accountable when a system — chatbot or agent — makes a mistake? Our [introduction to risk management](/blog/what-is-risk-management/) covers the underlying principle.
